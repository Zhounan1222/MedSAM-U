...
def parse_args():    
    ...
    parser.add_argument('-net', type=str, default='medsam', help='net type,sam,medsam')
    ...
    parser.add_argument('-exp_name', default='', type=str, help='net type')
    parser.add_argument('-type', type=str, default='map', help='condition type:ave,rand,rand_map')
    parser.add_argument('-vis', type=int, default=True, help='visualization')
    ...
    parser.add_argument('-medsam_ckpt', default='' , help='medsam checkpoint address')
